Profile: DDGDmpConsentEda
Parent: Consent
Id: ddg-dmp-consent-eda
Title: "DDG DMP Consent eDA Profile"
Description: "Consent for the DDG DMP eDA"
* ^version = "0.0.1"
* ^status = #draft
...
* policy 1..1 MS
  * authority 0..0
  * uri 1..1 MS
  * uri = "http://deutsche-diabetes-gesellschaft.de/fhir/ig/dmp-diabetes/consent/policy/eda"
